...
public class Dot_NormalObj : MonoBehaviour, IBezier
{
    ...
    Sprite LoadImage()
    {
        ...
        switch (keyCode)
        {
            case KeyCode.UpArrow:    { sb.Append("Up");    } break;
            case KeyCode.DownArrow:  { sb.Append("Down");  } break;
            case KeyCode.LeftArrow:  { sb.Append("Left");  } break;
            case KeyCode.RightArrow: { sb.Append("Right"); } break;
            default: break;
        }
...
#region IBezier ?ù∏?Ñ∞?éò?ù¥?ä§ Íµ¨ÌòÑ
